...
from kitchen.libs.shard import ShardEngine, create_object_base_model, create_relation_base_model
...
class RelationBaseModel(create_relation_base_model(shard_engine)):
    shard_func = choose_shard_id
